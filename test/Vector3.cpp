...
TEST(Vector3, Constructor) {
  ...
  EXPECT_TRUE(approximateEqual(vector.z, 3.0));
}
...
TEST(Vector3, CopyConstructor) {
  ...
  EXPECT_TRUE(approximateEqual(vector2.z, 3.0));
}
...
TEST(Vector3, SetValues) {
  ...
  EXPECT_TRUE(approximateEqual(vector.z, 0.0));
}
...
TEST(Vector3, Operators) {
  ...
  EXPECT_TRUE(approximateEqual(vector5.z, 2.0));
...
TEST(Vector3, Length) {
  ...
  vector1.set(3, 4, 12);
  EXPECT_TRUE(approximateEqual(vector1.length(), 13.0));
  EXPECT_TRUE(approximateEqual(vector1.lengthSquare(), 169.0));
...
TEST(Vector3, Normalize) {
  ...
  EXPECT_TRUE(approximateEqual(vector1.x, 1.0));
  EXPECT_TRUE(approximateEqual(vector1.y, 0.0));
  EXPECT_TRUE(approximateEqual(vector1.z, 0.0));

  EXPECT_TRUE(approximateEqual(vector2.x, 0.0));
  EXPECT_TRUE(approximateEqual(vector2.y, 1.0));
  EXPECT_TRUE(approximateEqual(vector2.z, 0.0));

  EXPECT_TRUE(approximateEqual(vector3.x, 0.0));
  EXPECT_TRUE(approximateEqual(vector3.y, 0.0));
  EXPECT_TRUE(approximateEqual(vector3.z, 1.0));

  EXPECT_TRUE(approximateEqual(vector4.x, 1.0));
  EXPECT_TRUE(approximateEqual(vector4.y, 0.0));
  EXPECT_TRUE(approximateEqual(vector4.z, 0.0));

  EXPECT_TRUE(approximateEqual(vector5.x, 0.0));
  EXPECT_TRUE(approximateEqual(vector5.y, 1.0));
  EXPECT_TRUE(approximateEqual(vector5.z, 0.0));

  EXPECT_TRUE(approximateEqual(vector6.x, 0.0));
  EXPECT_TRUE(approximateEqual(vector6.y, 0.0));
  EXPECT_TRUE(approximateEqual(vector6.z, 1.0));
}
